...
<img src="/assets/images/configs600/image45.jpeg" alt="Скриншот 45" height="500"/>

Ждем пока не появится стартовое меню, такое же как перед началом загрузки:

<img src="/assets/images/configs600/image46.jpeg" alt="Скриншот 46" height="500"/>

![Скриншот 39](/assets/images/configs600/image39.jpeg "Скриншот 39")

После того как появится это меню нажимаем 2- COLD START, далее соглашаемся с обнулением и перезагрузкой (2 Reset totals) 

<img src="/assets/images/configs600/image47.jpeg" alt="Скриншот 47" height="500"/>

<img src="/assets/images/configs600/image48.jpeg" alt="Скриншот 48" height="500"/>
